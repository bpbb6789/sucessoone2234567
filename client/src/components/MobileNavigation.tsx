import { Home, Play, PlusCircle, Radio, User, Activity, Coins, Search } from "lucide-react";
...
const navItems = [
  ...
  { icon: Search, label: "Explore", href: "/explorecontent" },
  { icon: PlusCircle, label: "Create", href: "/contentnew" },
